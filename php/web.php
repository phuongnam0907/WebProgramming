...
<title>Assignment - Web Templates</title>
    ...
    <div id="col-12">
      <div id="main">
      	<div class="row"> 
      		<div class="col-12">
            <div class="centerW">
              <a id="title" class="fa fa-firefox icon-bar"> Web</a>
            </div>
            <div class="centerSub">
              <a>Our beautifully-designed website templates come with hundreds of customizable features. Every template is just a starting point. No coding or HTML required.</a>
            </div>
          </div>
			<div class="col-12">
	      ...
	      $sql = "SELECT * FROM data WHERE type='web' LIMIT 0,9";
	  	...
	  	<div class="col-12">
			<div class="center">
				...
				<a href="../php/web.php" class="number here">1</a>
				<a href="../php/web_2.php" class="number">2</a>
				<a href="../php/web_2.php" class="number">&raquo;</a>
			</div>
		</div>
      </div>
      <div style="clear:both"></div>
