...
session_destroy();
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $max_id = mysqli_fetch_assoc(mysqli_query($db,"SELECT MAX(ID) FROM admin"));
      $maxid = $max_id['MAX(ID)'] + 1;

      $myusername = mysqli_real_escape_string($db,$_POST['lastname']);
      $mypassword = mysqli_real_escape_string($db,$_POST['password']); 
      $myemail = mysqli_real_escape_string($db,$_POST['email']);
      $myphone =  mysqli_real_escape_string($db,$_POST['firstname']);

      $sql_count = "SELECT COUNT(*) FROM admin WHERE username='$myusername'";
      $result1 = mysqli_query($db, $sql_count);
      $row1 = mysqli_fetch_assoc($result1);
      $count = $row1['COUNT(*)'];
      
      if($count == 0){
        $sql = "INSERT INTO admin (id,username,passcode,type,email,phone) VALUES ('$maxid','$myusername','$mypassword','user','$myemail','$myphone')";
        $result = mysqli_query($db,$sql);
        if (!$result) die("Error to register.");
        else {
          ...
          echo '<script language="javascript">';
          echo 'alert("Username is existed...")';
          echo '</script>';
      ...
      <div id="main">
          ...
          <div class="content-w3ls">
            <div class="content-agile1">
                <h2 class="agileits1">WelCome To Our Template</h2>
                <div class="content-Click">
                  <p><span></span> <a href="../php/signin.php"> Sign In</a></p>
                </div>
            </div>
            <div class="content-agile2">
                <form action="" method="post">
                  <div class="form-control"> 
                    <input type="text" id="lastname" name="lastname" placeholder="username" title="Please enter your username" required maxlength="50" minlength="2" style="text-transform: lowercase;">
                  </div>
                  <div class="form-control">  
                  ...
                  <div class="form-control">  
                    <input type="password" class="lock" name="password" placeholder="password" id="password1" required minlength="4" maxlength="32">
                  </div>  
                  ...
                  <div class="form-control">  
                    <input type="text" id="firstname" name="firstname" placeholder="phone number" title="Please enter your phone number">
                  </div>
            ...
            <p class="wthree w3l">Đăng ký nhanh</p>
