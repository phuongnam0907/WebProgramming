    ...
    <div id="col-12">
      <div id="main">
      	<div class="row"> 
      		<div class="col-12">
      			<div class="centerP">
      				<a id="title" class="fa fa-file-powerpoint-o icon-bar"> Power Point</a>
      			</div>
      			<div class="centerSub">
      				<a>Create captivating presentations quickly and affordably with customizable design layouts that include photos and artwork.</a>
      			</div>
      		</div>
			<div class="col-12">
	      ...
	      $sql = "SELECT * FROM data WHERE type='powerpoint' LIMIT 9,9";
	  	...
	  	<div class="col-12">
			<div class="center">
				<a href="../php/powerpoint.php" class="number">&laquo;</a>
				<a href="../php/powerpoint.php" class="number">1</a>
				<a href="../php/powerpoint_2.php" class="number here">2</a>
				<a href="../php/powerpoint_3.php" class="number">3</a>
				<a href="../php/powerpoint_3.php"  class="number">&raquo;</a>
			</div>
		</div>
      </div>
      <div style="clear:both"></div>
