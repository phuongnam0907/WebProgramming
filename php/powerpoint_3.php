  ...
  <div id="container">
    ...
    <div id="col-12">
      ...
      <div class="col-12">
        ...
        $sql = "SELECT * FROM data WHERE type='powerpoint' LIMIT 18,9";
      ...
      <div class="col-12">
      <div class="center">
        <a href="../php/powerpoint_2.php" class="number">&laquo;</a>
        <a href="../php/powerpoint.php" class="number">1</a>
        <a href="../php/powerpoint_2.php" class="number">2</a>
        <a href="../php/powerpoint_3.php" class="number here">3</a>
