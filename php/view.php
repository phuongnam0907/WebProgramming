...
<body> 
  <div id="container">
    ...
    <div id="bodypage">
      ...
      <hr>
      <a href="../php/privateadmin.php">Account Information</a>&nbsp;|&nbsp;<a href="../php/list.php">Manage Accounts</a>&nbsp;|&nbsp;<a href="../php/view.php" style="text-decoration: blink;"><b>Manage Upload Files</b></a>&nbsp;|&nbsp;<a href="../php/indexup.php">Upload File</a>&nbsp;|&nbsp;&nbsp;<a href="../php/signout.php" style="font-family: fantasy; color: red; font-size: 16px;">Sign Out</a>
      <hr>
      <div id="main">
        ...
        <div id="bodya">
            ...
            <tr>
            <th colspan="7"><label>Preview Uploading Files</label>&nbsp;&nbsp;<a href="../php/indexup.php" style="font-style:italic; color: #0AA;">[Upload Here]</a></th>
            </tr>
            <tr>
            <th>File Name</th>
            <th>File Type</th>
            ...
            if ($result_set == NULL) echo "<tr><td colspan='6' style='text-align:center;'>Null Data <a href='../php/indexup-user.php' style=' color: #0AA;''>Upload Something</a></td></tr>";
