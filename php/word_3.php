  ...
  <div id="container">
    ...
    <div id="col-12">
      ...
      <div class="col-12">
        ...
        $sql = "SELECT * FROM data WHERE type='word' LIMIT 18,9";
      ...
      <div class="col-12">
        <div class="center">
          <a href="../php/word_2.php" class="number">&laquo;</a>
          <a href="../php/word.php" class="number">1</a>
          <a href="../php/word_2.php" class="number">2</a>
          <a href="../php/word_3.php" class="number here">3</a>
          <aclass="number">&raquo;</a>
        </div>
      </div>
    </div>
      <div style="clear:both"></div>
