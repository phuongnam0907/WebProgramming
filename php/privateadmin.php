    ...
    <div id="bodysignin">
      <div id="main">
          ...
          <div class="content-w3ls" style="background-color: #e3e7ed; opacity: 0.8; border-radius: 60px;">
            <div class="content-agile1 " style="background: #c4d4ed; border-radius: 60px; min-height:550px;">
              <div align="center" style="margin-top: 30px;"><img src="../images/avatarW.jpg" width="30%;"></img>
              ...
              <div align="center" style="padding-bottom: 10px;">
                ...
                <button class="pripage" onclick="window.location.href='./list.php'"><b>Trang Quản Lý</b></button>
              </div>
            </div>
