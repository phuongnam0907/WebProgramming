  ...
  <div id="container">
    ...
    <div id="col-12">
      <div id="main">
	      ...
	      $sql = "SELECT * FROM data WHERE type='web' LIMIT 9,9";
          ...
          <div class="col-12">
            <div class="center">
              <a href="../php/web.php" class="number">&laquo;</a>
              <a href="../php/web.php" class="number">1</a>
              <a href="../php/web_2.php" class="number here">2</a>
