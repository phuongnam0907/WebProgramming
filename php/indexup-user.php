...
<body> 
  <div id="container">
    ...
    <div id="bodypage">
      <h3>USER Pages</h3>
      <hr>
      <a href="../php/privatepage.php">Account Information</a>&nbsp;|&nbsp;<a href="../php/view-user.php">View Files</a>&nbsp;|&nbsp;<a href="../php/indexup-user.php" style="text-decoration: blink;"><b>Upload File</b></a>&nbsp;|&nbsp;&nbsp;<a href="../php/signout.php" style="font-family: fantasy; color: red; font-size: 16px;">Sign Out</a>
      <hr>
      <div id="main">
		...
		<div id="bodya">
			...
			if(isset($_GET['success']))
			{
				...
				<div class="alert success">
		          ...
		          <label>File Uploaded Successfully...  <a href="view-user.php">click here to view file.</a></label>
				</div>
		        <?php
			}
